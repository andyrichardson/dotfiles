...
# pacmd load-module module-ladspa-sink sink_name=mic_raw_in sink_master=mic_denoised_out label=noise_suppressor_stereo plugin=/nix/store/4hai6z1ip1qbi8w8lx4fd6kikh7mwzl4-noise-suppression-for-voice-1.0.0/lib/ladspa/librnnoise_ladspa.so control=50
